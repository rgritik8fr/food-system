...
if(isset($_POST['submit'])){
    ...
    $loginsql =  "SELECT * FROM `admin` WHERE user = '$username'";
    $qadmincheck = mysqli_query($con,$loginsql);
    if(mysqli_num_rows($qadmincheck)>0){
      $row = mysqli_fetch_assoc($qadmincheck);
      $fetchpass = $row['pass'];
      $passmatch = password_verify($password,$fetchpass);
      ...
      if($passmatch){
        ...
        $msg ="please Enter your valid infomation";
      }
